...
#20
#dia = input("porfavor ingrese su dia de nacimiento en numeros: ")
#mes = input("porfavor ingrese su dia de mes en numeros: ")
#ano = input("porfavor ingrese su dia de años en numeros: ")
#fecha = dia + "" + mes + "" + ano
fecha_b = int(input("ingrese su fecha de nacimineto toda junta sin espacios con el siguiente formato: ddmmaaaa    "))
print(f"la fecha de nacimiento es: {fecha_b}")
